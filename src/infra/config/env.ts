...
export interface Env {
  ...
  ML_SERVICE_API_KEY: string | undefined;
  FACT_CHECK_LANGUAGE_CODE: string;
...
export const loadEnv = (
  ...
  ML_SERVICE_API_KEY: readOptional(source, "ML_SERVICE_API_KEY"),
  FACT_CHECK_LANGUAGE_CODE: source.FACT_CHECK_LANGUAGE_CODE ?? "pt-BR",
